...
2. Name two big differences between `display: block;` and `display: inline;`.
   display Block displays elements accross the page. and the next element goes to the next line.
   display inline elements sit next to each other on the same line.
...
5. Explain why git is valuable to a team of developers.
   Git helps keep track of changes across the project. Where as you are working alone or in a team environment. Git helps streamline and organize the changes from start to finish.
